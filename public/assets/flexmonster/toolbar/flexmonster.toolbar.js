...
FlexmonsterToolbar.prototype.init = function () {
  ...
  var createToolbar = function () {
    ...
    if (!_this.osUtils.isMobile) {
      //left group and right group is only supported for desktop version
    ...
    if (!_this.osUtils.isMobile && leftGroup.clientWidth + rightGroup.clientWidth > _this.toolbar.clientWidth) {
      //checks if we have enouph space for all tabs
  ...
  var createToolbarContentFromTabs = function (leftGroup, rightGroup, toolbar) {
    //fills toolbar with the defined tabs
  ...
  var clear = function () {
    // clears old toolbar from DOM
    if (_this.toolbarWrapper) {
      var elementsToDelete = [];
      var children = _this.toolbarWrapper.childNodes;
      for (var i = 0; i < children.length; i++) {
        var classList = children[i].classList;
        if (!(classList.contains('fm-popup') || classList.contains('fm-modal-overlay') || classList.contains('fm-popup-modal-overlay'))) {
  ...
  var enableToolbarScrolling = function () {
    //enables scrolling if possible
...
FlexmonsterToolbar.prototype.updateLabels = function (labels) {
  ...
  this.setText(
    this.pivotContainer.querySelector('#fm-tab-connect-remote-json .fm-tab-label'),
    this.osUtils.isMobile ? Labels.connect_remote_json_mobile : Labels.connect_remote_json,
  );
  ...
  this.setText(
    this.pivotContainer.querySelector('#fm-tab-format-conditional .fm-tab-label'),
    this.osUtils.isMobile ? Labels.conditional_formatting_mobile : Labels.conditional_formatting,
  );
...
FlexmonsterToolbar.prototype.icons = {
  ...
  connect_elastic:
    '<svg width="50" height="50" viewBox="-14 -14 150 150" xmlns="http://www.w3.org/2000/svg"><path d="m53.2 68h-32.4c-1.2-3.8-1.8-7.8-1.8-12s0.6-8.2 1.8-12h53.2c6.7 0 12 5.4 12 12s-5.3 12-11.9 12h-20.9zm-1.5 4h-29.4c3.1 7.1 8.2 13.2 14.7 17.4 6.3 4.2 13.9 6.6 22 6.6 13.9 0 26.1-7.1 33.3-17.8-3.7-3.8-8.9-6.2-14.6-6.2h-26zm26-32c5.7 0 10.9-2.4 14.6-6.2-7.2-10.7-19.4-17.8-33.3-17.8-8.1 0-15.7 2.4-22 6.6-6.4 4.2-11.5 10.3-14.7 17.4h55.4z" class="fill-border" /></svg>',
...
FlexmonsterToolbar.prototype.icons_v26 = {
  ...
  export:
    '<svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36"><polygon points="14 27 22 27 22 15 27 15 18 5 9 15 14 15 "/><path d="M32.5 21h-5c-0.3 0-0.5 0.2-0.5 0.5s0.2 0.5 0.5 0.5H32v10H4V22h4.5C8.8 22 9 21.8 9 21.5S8.8 21 8.5 21h-5C3.2 21 3 21.2 3 21.5v11C3 32.8 3.2 33 3.5 33h29c0.3 0 0.5-0.2 0.5-0.5v-11C33 21.2 32.8 21 32.5 21z"/></svg>',
  export_print:
    '<svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36"><path d="M23 23H13v1h10V23L23 23z"/><path d="M13 25v1h10v-1H13z"/><path d="M26 12V5H10v7H6v14h3v4h18v-4h3V12H26zM11 6h14v6H11V6zM26 29H10v-9h16V29zM26 17.8c-1.1 0-2-0.9-2-2s0.9-2 2-2c1.1 0 2 0.9 2 2S27.1 17.8 26 17.8z"/><path d="M26 14.6c0.7 0 1.2 0.5 1.2 1.2 0 0.7-0.5 1.2-1.2 1.2 -0.7 0-1.2-0.5-1.2-1.2C24.8 15.1 25.3 14.6 26 14.6z"/></svg>',
  export_excel:
  ...
  charts_line:
    '<svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36"><polygon points="32 30 5 30 5 3 4 3 4 31 32 31 32 30 "/><path d="M9.4 24c1.3 0 2.4-1.1 2.4-2.3 0-0.7-0.3-1.3-0.8-1.8l2.8-4.3c0.4 0.1 0.6 0.2 1 0.2 0.8 0 1.4-0.3 1.9-0.7l2.8 2.6c-0.2 0.4-0.2 0.6-0.2 0.9 0 1.2 1 2.2 2.1 2.2 1.3 0 2.2-1 2.2-2.2 0-0.2 0-0.5-0.1-0.8l2.9-8c0.6 0.5 1.3 0.7 2.1 0.7 1.6 0 3-1.3 3-3.1 0-1.7-1.3-3.1-3-3.1 -1.7 0-3.1 1.4-3.1 3.1 0 0.6 0.2 1.1 0.4 1.6l-2.8 8c-0.4-0.5-0.9-0.7-1.6-0.7 -0.5 0-1 0.2-1.4 0.6l-2.8-2.7c0.1-0.4 0.2-0.8 0.2-1.2 0-1.6-1.1-2.8-2.7-2.8 -1.4 0-2.7 1.3-2.7 2.8 0 0.8 0.4 1.5 0.9 2.1l-2.8 4.2c-0.2-0.1-0.5-0.1-0.8-0.1C8.1 19.2 7 20.3 7 21.7 7 22.9 8.1 24 9.4 24z"/></svg>',
  charts_pie:
    '<svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36"><path d="M25.2 28.8c3.3-2.2 5.5-5.8 5.8-9.8h-12L25.2 28.8z"/><path d="M17 18v-13c-7 0.4-12 6.1-12 13 0 7.2 5.9 13 13 13 2.1 0 4-0.5 5.8-1.4C23.8 29.6 17 18.2 17 18z"/><path d="M18 5V18h13l0-0.9C30.6 10.6 25 5.4 18 5z"/></svg>',
  charts_scatter:
    '<svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36"><polygon points="32 30 5 30 5 3 4 3 4 31 32 31 "/><path d="M9.5 20c1.4 0 2.5 1.1 2.5 2.5 0 1.4-1.1 2.5-2.5 2.5S7 23.9 7 22.5C7 21.1 8.1 20 9.5 20z"/><path d="M21.5 17c1.4 0 2.5 1.1 2.5 2.5 0 1.4-1.1 2.5-2.5 2.5S19 20.9 19 19.5C19 18.1 20.1 17 21.5 17z"/><path d="M14 11c1.7 0 3 1.3 3 3s-1.3 3-3 3 -3-1.3-3-3S12.3 11 14 11z"/><path d="M28 6c1.7 0 3 1.3 3 3 0 1.7-1.3 3-3 3s-3-1.3-3-3C25 7.3 26.3 6 28 6z"/></svg>',
  format:
...
FlexmonsterToolbar.prototype.showFormatCellsDialog = function (measureName, measureAggregation) {
  ...
  var valuesDropDownChangeHandler = function () {
    ...
    if (
      (formatObject.hasOwnProperty('textAlign') ||
        formatObject.hasOwnProperty('thousandsSeparator') ||
        formatObject.hasOwnProperty('decimalSeparator') ||
        formatObject.hasOwnProperty('decimalPlaces') ||
        formatObject.hasOwnProperty('currencySymbol') ||
        formatObject.hasOwnProperty('positiveCurrencyFormat') ||
        formatObject.hasOwnProperty('negativeCurrencyFormat') ||
        formatObject.hasOwnProperty('nullValue') ||
        formatObject.hasOwnProperty('isPercent')) &&
      currentMeasureNames &&
      currentMeasureNames.length > 0
    ) {
  ...
  var switchToMeasure = function () {
    ...
    var formatVO = currentMeasure ? self.pivot.getFormat(currentMeasure[0], currentMeasure[1]) : self.pivot.getFormat(null);
  ...
  var applyHandler = function () {
    ...
    for (var i = 0; i < measuresList.length; i++) {
      ...
      self.pivot.setFormat(formatVO, measure[0] == '' ? null : measure[0], self.singleAggregationFormatting ? undefined : measure[1]);
    }
  ...
  var getDropDownLabel = function (measure) {
    ...
    var aggregation = aggregationLabelIndex === -1 || measure.aggregation === 'none' || measure.calculated ? null : measure.availableAggregationsCaptions[aggregationLabelIndex];
    return aggregation === null || self.singleAggregationFormatting ? measure.name : measure.name + ' (' + aggregation + ')';
  };
  ...
  for (var i = 0; i < _measures.length; i++) {
    if (
      !_uniqueNames[_measures[i].uniqueName] ||
...
FlexmonsterToolbar.prototype.showConditionalFormattingDialog = function (measureName) {
  ...
  for (var i = 0; i < conditions.length; i++) {
    // creating a map where the key is measure's uniqueName for which the condition is defined
    _conditionsMeasuresMap[conditions[i].measure] = 1;
  }
  for (var i = 0; i < _allMeasures.length; i++) {
    // adding all the measures for which the condition is defined to the dropdown the list
  ...
  for (var i = 0; i < _measures.length; i++) {
    // adding all the measures from the slice.measures list to the dropdown the list
    var uniqueName = isMSAS ? _measures[i].uniqueName : getMeasureUniqueName(_measures[i]);
    if (
      ((_measures[i].type === 'number' || _measures[i].type === 'float' || _measures[i].type === 'long') && _measureWithAggregations[uniqueName] === undefined) ||
...
FlexmonsterToolbar.prototype.defaults.fonts = [
  'Arial',
  'Lucida Sans Unicode',
  'Verdana',
  'Courier New',
...
FlexmonsterToolbar.prototype.createConditionalFormattingItem = function (data, allConditions, isMSAS) {
  ...
  var getDropDownLabel = function (measure) {
    var aggregationLabelIndex = measure.availableAggregations.indexOf(measure.aggregation);
    var aggregation = aggregationLabelIndex === -1 || measure.aggregation === 'none' || measure.calculated ? null : measure.availableAggregationsCaptions[aggregationLabelIndex];
    return aggregation === null || _isMSAS ? measure.name : measure.name + ' (' + aggregation + ')';
  };
  ...
  function fillValuesDropDown(measures, selectedMeasure, selectedMeasureAggregation) {
    ...
    for (var i = 0; i < measures.length; i++) {
      if (isFlatTable && measures[i].type == 7) {
        // count measure
        continue;
      }
      dataProvider.push({
    ...
    valuesDropDown.setValue(
      selectedMeasure && selectedMeasureAggregation !== undefined
        ? getMeasureUniqueName(selectedMeasure, selectedMeasureAggregation)
        : selectedMeasure
        ? selectedMeasure
        : dataProvider[0].value,
    );
  }
...
FlexmonsterToolbar.prototype.showOptionsDialog = function () {
  ...
  if (
    options != null &&
    options.hasOwnProperty('dataSource') &&
    !(options['dataSource']['type'] == 'microsoft analysis services' || options['dataSource']['type'] == 'mondrian' || options['dataSource']['type'] == 'elasticsearch')
  ) {
...
FlexmonsterToolbar.prototype.enterFullscreen = function (element) {
  if (element.requestFullscreen || element.webkitRequestFullScreen || element.mozRequestFullScreen || (element.msRequestFullscreen && window == top)) {
    var _this = this;
  ...
  dropdown.getValue = function () {
    ...
    if (allowMuliselect) {
      ...
      return _selectedItemIndexes.map(function (index) {
        return typeof _dataProvider[index] === 'string' ? _dataProvider[index] : _dataProvider[index].value;
      });
    }
    return typeof _dataProvider[_selectedItemIndexes[0]] === 'string' ? _dataProvider[_selectedItemIndexes[0]] : _dataProvider[_selectedItemIndexes[0]].value;
  };
...
FlexmonsterToolbar.prototype.createTab = function (data, parent) {
  ...
  if (!this.nullOrUndefined(_handler)) {
    tabLink.onclick = (function (handler, args) {
      return function () {
  ...
  if (!this.nullOrUndefined(_onShowHandler)) {
    tabLink.onmouseover = (function (handler) {
      return function () {
        handler.call(_this);
      };
    })(_onShowHandler);
...
FlexmonsterToolbar.prototype.createTabMenu = function (dataProvider, parentTab) {
  ...
  function show() {
    ...
    if (
      (menuRect.left > parentRect.right - arrowWidth || menuRect.left < parentRect.left + arrowWidth) &&
      parentRect.right + menuRect.width < toolbarRect.right &&
      _this.toolbar.scrollLeft > 0
    ) {
      // this case handles left positioning with scroll
    ...
    } else if (menuRect.right > toolbarRect.right - arrowWidth && parentRect.left + parentRect.width / 2 - menuRect.width > 0) {
      //this case handles right positioning
    ...
    } else if (leftScrollArrowRect && parentRect.left < leftScrollArrowRect.right) {
      // this case handles left positon on the edge
      menuContainer.style.left = 0;
      menuList.classList.add('fm-dropdown-scrollable-left');
    }
    setActiveItemAt(-2);
...
FlexmonsterToolbar.prototype.isDisabled = function (data) {
  ...
  return (
    data.visible === false || (data.ios === false && this.osUtils.isIOS) || (data.android === false && this.osUtils.isAndroid) || (data.mobile === false && this.osUtils.isMobile)
  );
};
...
FlexmonsterToolbar.prototype.osUtils = {
  ...
  isMobile:
    ...
    /ReactNative/i.test(navigator.product),
};
