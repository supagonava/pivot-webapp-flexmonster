...
(function () {
    ...
    window["FlexmonsterGooglecharts"] = FlexmonsterGooglecharts;
    ...
    FlexmonsterGooglecharts.getNumberFormat = function (format) {
        ...
        if (format["currencySymbol"] != undefined && format["currencySymbol"] != "") {
            if (format["positiveCurrencyFormat"] == "$1" || (format["isPercent"] == true && format["currencySymbol"] == "%")) {
    ...
    FlexmonsterGooglecharts.getNumberFormatPattern = function (format) {
        ...
        if (format["currencySymbol"] != undefined && format["currencySymbol"] != "") {
            str = (format["positiveCurrencyFormat"] == "$1" || (format["isPercent"] == true && format["currencySymbol"] == "%")) ?
